...
//
//             var username = await _parser.GetUsernameFromId(malUser.MyAnimeListId);
...
//             {
//                 await user.SendMessageAsync($"Your Verification Code is: `{malUser.Token}`.");
//                 return;
//             }
//
//             if (malUser is null)
